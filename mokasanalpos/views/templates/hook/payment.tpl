<link rel="stylesheet" type="text/css" href="{$module_dir|escape:'htmlall':'UTF-8'}views/css/moka.css">
    <div class= "row"> 
        <div class="col-xs-12">
            ...
            <style>
                p.payment_module a.mokasanalpos {
                    background: url({$module_dir}img/mokaicon.png) 15px 12px no-repeat #fbfbfb;
                </style>   <a class="mokasanalpos" href="javascript:toggleform();" title="{$credit_card}">
                ...
                <div id="moka-form" class="mokaform" style="display: none;"> 
                            ...
                            <div class="tekcekim-container ">
                                ...
                                <div class="tekcekim">
                                    ...
                                    <li class="taksit-li " for="s-option" >
                                        <input type="radio" id="s-option"  name="mokatotal"  value="{$total}" checked class="option-input radio " >
                            ...
                            <div class="taksit-container ">
                                ...
                                <div class="{$bank}">
                                    ...
                                    <li class="taksit-li mokaorta">
                                        <input type="radio" id="s-option_{$bank}_{$ins}" name="mokatotal[{$bank}][{$ins}]" value="{$rates.$bank.installments.$ins.total}" class="option-input radio">
                                            <label for="s-option2">{$ins} Taksit</label>
                                            <div class="taksit-fiyat"> {displayPrice price=$rates.$bank.installments.$ins.total} / {displayPrice price=$rates.$bank.installments.$ins.monthly} </div>
                                            <div class="check"><div class="inside"></div></div>
                                    </li>
...
if(taksit=='taksit'){	
            $(document).ready(function () {
                ...
                $(".maximum-logo").click(function () {
                    ...
                    $(".maximum").show();
                    $("#s-option_maximum_1").attr('checked', true);
                });
                ...
                $(".cardfinans-logo").click(function () {
                    ...
                    $(".taksit-container").show();
                    $(".cardfinans").show();
                    $("#s-option_cardfinans_1").attr('checked', true);
                });
                $(".axess-logo").click(function () {
                    cardshow(0);
                    $(".taksit-container").show();
                    $(".axess").show();
                    $("#s-option_axess_1").attr('checked', true);
                });
                $(".bonus-logo").click(function () {
                    cardshow(0);
                    $(".taksit-container").show();
                    $(".bonus").show();
                    $("#s-option_bonus_1").attr('checked', true);
                });
                $(".world-logo").click(function () {
                    cardshow(0);
                    $(".taksit-container").show();
                    $(".world").show();
                    $("#s-option_world_1").attr('checked', true);
                });
            ...
            function toggleform() {
                var ele = document.getElementById("moka-form");
